-- Active: 1747511713679@@127.0.0.1@3306@tarea2
...
-- Opcional: asegurarse de que el usuario root tiene permisos (normalmente los tiene por defecto)
-- GRANT ALL PRIVILEGES ON tarea2.* TO 'root'@'localhost';
-- FLUSH PRIVILEGES;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `actividad_tema` (
  `id` INT NOT NULL AUTO_INCREMENT,
